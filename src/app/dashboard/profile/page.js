        ...
        <div className="bg-[#131415] border border-[#110c1f] backdrop-blur-md w-full p-10 rounded-2xl">
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="mb-10 flex justify-between items-center">
              <div className="flex items-center gap-6">
                ...
                <label
                  ...
                  className="bg-gradient-to-r from-neutral-500 to-neutral-500 hover:from-gray-500 hover:to-gray-500 transition-all duration-500 text-[15px] text-white font-bold px-6 py-3 rounded-lg"
                >
            ...
            <div className="space-y-4">
              ...
              <input
                className="bg-[#1a202c] p-4 rounded-lg w-full outline-none"
                name="full_name"
